    ...
    def loss_per_scale(name, yolo_layer_outputs, conv_layer_outputs, y_true, y_true_boxes, ignore_thresh, anchors, num_classes=3, h=100, w=100, batch_size=32):
        ...
        def iou(name, prct_yolo_outputs, y_true_boxes, shape, batch_size):
            ...
            shape : list
                ...
                [batch_size, yolo_layer_grid_h, yolo_layer_grid_w, num_anchors_per_layer, (6+num_classes)]
                The '6' represents the x_coord, y_coord, width_value, height_value, theta, and class_number.
        ...
        with tf.variable_scope(name):
            ...
            with tf.variable_scope('trnsfrm_y_true'):
                ...
                percent_x, percent_y, percent_w, percent_h, theta, obj_mask, classes = tf.split(y_true, [1, 1, 1, 1, 1, 1, num_classes], axis=-1)
            ...
            with tf.variable_scope('pred_coords_loss'):
                ...
                with tf.variable_scope('concat_cnvrtd_y_true'):
                    converted_y_true = tf.concat([converted_x_true,converted_y_true,converted_w_true,converted_h_true, theta ], axis=-1)
            ...
            with tf.variable_scope('pred_class_loss'):
                ...
                class_loss = obj_mask * tf.nn.sigmoid_cross_entropy_with_logits(labels=y_true[...,6:], logits=conv_layer_outputs[...,6:])
