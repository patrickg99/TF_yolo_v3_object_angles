...
def create_y_true(box_data, anchors, num_classes, h=416, w=416):
        ...
        def load_data(box_data, best_anchors, anchors_mask, grid_size, num_classes):
            ...
            y_true = np.zeros([box_data_shape[0] * int(grid_size[0]) * int(grid_size[1]) * num_anchors, 6+num_classes])
            ...
            y_true = y_true.reshape([box_data_shape[0], int(grid_size[0]) * int(grid_size[1]) * num_anchors, num_classes+6])
